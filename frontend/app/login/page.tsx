      ...
      <div className="w-full max-w-[26rem]">
        ...
        <div className="bg-white border border-gray-100 rounded-[2rem] p-8 sm:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          ...
          <form className="space-y-5">
            ...
            <button className="w-full bg-gray-900 hover:bg-black text-white font-bold text-[15px] py-4 rounded-xl transition-all shadow-[0_4px_20px_-4px_rgba(0,0,0,0.2)] mt-4">
              Log in
            </button>
          </form>
